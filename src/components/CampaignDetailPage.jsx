                ...
                <div className="p-6 space-y-6">
                        ...
                        <div className="flex flex-col md:flex-row gap-6">
                            <div className="flex-shrink-0">
                                <video
                                    ...
                                    controls
                                    className="rounded-lg object-cover w-[200px] h-[160px]"
                            ...
                            <div className="flex-1 flex flex-col gap-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-gray-700">
                                    <div className="space-y-2">
                                        <div className="flex">
                                            <span className="w-[80px] text-gray-500">Duration:</span>
                                        ...
                                        <div className="flex">
                                            ...
                                            <span>
                                                {`${new Date(campaignData.campaignStartDate).toLocaleDateString()} - ${new Date(campaignData.campaignEndDate).toLocaleDateString()}`}
                                            </span>                    </div>
                                ...
                                <div className="p-5 rounded-xl bg-[var(--bg-color-off-white)]">
                                    ...
                                    <div className="p-1 relative">
                                        <ProgressBar
                                            ...
                                            text={{ left: campaignData?.surveyQuestion1?.option1, right: "0%" }}
                                        />
                                    </div>
                                    <div className="p-1 relative">
                                        <ProgressBar
                                            value={60}
                                            fill="bg-white rounded-xl"
                                            text={{ left: campaignData?.surveyQuestion1?.option2, right: "0%" }}
                                        />
                                    </div>
                                    <div className="p-1 relative">
                                        <ProgressBar
                                            value={45}
                                            fill="bg-white rounded-xl"
                                            text={{ left: campaignData?.surveyQuestion1?.option3, right: "0%" }}
                                        />
                                    </div>
                                    <div className="p-1 relative">
                                        <ProgressBar
                                            value={30}
                                            fill="bg-white rounded-xl"
                                            text={{ left: campaignData?.surveyQuestion1?.option4, right: "0%" }}
                                        />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="p-5 rounded-xl bg-[var(--bg-color-off-white)]">
                                    ...
                                    <div className="p-1 relative">
                                        <ProgressBar
                                            value={25}
                                            fill="bg-white rounded-xl"
                                            text={{ left: campaignData?.surveyQuestion2?.option1, right: "0%" }}
                                        />
                                    </div>
                                    <div className="p-1 relative">
                                        <ProgressBar
                                            value={60}
                                            fill="bg-white rounded-xl"
                                            text={{ left: campaignData?.surveyQuestion2?.option2, right: "0%" }}
                                        />
                                    </div>
                                    <div className="p-1 relative">
                                        <ProgressBar
                                            value={45}
                                            fill="bg-white rounded-xl"
                                            text={{ left: campaignData?.surveyQuestion2?.option3, right: "0%" }}
                                        />
                                    </div>
                                    <div className="p-1 relative">
                                        <ProgressBar
                                            value={30}
                                            fill="bg-white rounded-xl"
                                            text={{ left: campaignData?.surveyQuestion2?.option4, right: "0%" }}
                                        />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="flex flex-col md:flex-row p-4 mt-4 mb-4 bg-white rounded-xl">
                        <div className="flex-1 p-6">
                            ...
                            <p className="text-2xl font-bold text-gray-800">{campaignData.impressions}</p>
                        </div>
                        ...
                        <div className="flex-1 bg-white rounded-xl p-6">
                            ...
                            <p className="text-2xl font-bold text-gray-800">{campaignData.engagements?.totalCount}</p>
                        </div>
