            ...
            <div className="bg-white p-3 md:p-4 rounded-[16px] border-1 mb-2 w-full">
                {isExpanded && (
                    <>
                        <div className="mb-3">
                            ...
                            <div className="relative">
                                ...
                                <div className="flex justify-between items-end">
                                    ...
                                    <div className={`text-xs ${currentQuestion.text.length > MAX_QUESTION_LENGTH ? 'text-red-500' : 'text-gray-500'
                                        }`}>
                                        {currentQuestion.text.length}/{MAX_QUESTION_LENGTH}
                                    </div>
                                </div>
                        ...
                        >
                            {isQuiz ? "Update Quiz Question" : "Update Survey Question"}
                        </button>
                    </>
                )}
                {alert.visible && (
                ...
                {!isExpanded && currentQuestion.text && (
